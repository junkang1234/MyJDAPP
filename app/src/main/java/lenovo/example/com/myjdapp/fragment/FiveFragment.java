...
import lenovo.example.com.myjdapp.adapter.MyFiveAdapter;
...
public class FiveFragment extends Fragment implements OrderView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.fivefragment,null);
        initViw(view);
        loadData();
    ...
    public void Success(OrderBean baseBean) {
        ...
        if(data1!=null&&data1.size()!=0){
            ...
            recy.setAdapter(new MyFiveAdapter(getActivity(),data));
        }else {
