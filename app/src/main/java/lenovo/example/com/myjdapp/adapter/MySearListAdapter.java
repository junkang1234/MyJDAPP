...
public class MySearListAdapter extends RecyclerView.Adapter{

    private Context context ;
    private List<SearListBean.DataBean> list = new ArrayList<>();
    private int layout ;
    public MySearListAdapter(Context context, List<SearListBean.DataBean> list, int layout) {
        this.context = context;
        this.list = list;
        this.layout=layout;
    }

    public void adData(List<SearListBean.DataBean> l){
        list.addAll(l);
